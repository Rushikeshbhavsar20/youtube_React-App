...
const Sidebar = () => {
  return (
    <div className=' w-[4%] h-full pt-[25px]'>
        <div className='flex flex-col h-full items-center gap-1 '>
            <div className='w-[63px] h-[70px] flex flex-col items-center justify-center   '>
            ...
            <div className='w-[63px]  h-[70px] bg-white  flex flex-col items-center justify-center '>
